...
export function ECGProjectCard({
  title,
  description,
  tags,
  image,
                ...
                <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto bg-zinc-900 border-zinc-700 text-white custom-scrollbar-phthalo">
                  <DialogHeader>
                    <DialogTitle className="text-xl font-bold text-white">
                      ECG Arrhythmia Detector - App Support
                    </DialogTitle>
                    <DialogDescription className="text-zinc-400">
                      Support information and user guide for the ECG monitoring
                      application
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <div className="space-y-6 mt-4">
                    ...
                    <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
                      <h4 className="text-lg font-semibold mb-2 text-phthalo-400">
                        📧 Contact & Support
                      </h4>
                      <p className="text-zinc-300">
                        <strong className="text-white">App Support:</strong>{" "}
                        danish0@gmail.com
                      </p>
                      <p className="text-zinc-400 text-sm mt-1">
                        For questions about ECG Arrhythmia Detector, please
                        contact me directly.
                      </p>
                    </div>
                    ...
                    {/* Getting Started */}
                    <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
                      <h4 className="text-lg font-semibold mb-3 text-phthalo-400">
                        🚀 Getting Started
                      </h4>
                      <ul className="text-zinc-300 space-y-2 text-sm">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            Ensure your ECG device is properly positioned and
                            moistened
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>
                            Allow 40 beats for training, then begin monitoring
                          </span>
                        </li>
                      </ul>
                    </div>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <p className="text-zinc-400 text-sm">
                            Check Bluetooth is enabled and device is on
                          </p>
                        </div>
                        <div>
                          <p className="text-white font-medium text-sm">
                          ...
                          <p className="text-zinc-400 text-sm">
                            Ensure chest strap is moistened and properly
                            positioned
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-zinc-400 text-sm">
                            App will automatically attempt to reconnect
                          </p>
                        </div>
                        <div>
                          <p className="text-white font-medium text-sm">
                          ...
                          <p className="text-zinc-400 text-sm">
                            Ensure stable connection and normal heart rhythm
                            during initial 40 beats
                          </p>
                        </div>
                      </div>
                    </div>
                      ...
                      <ul className="text-zinc-300 space-y-2 text-sm">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            ...
                            Live 130Hz streaming from ECG device
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>
                            ...
                            Advanced morphology-based arrhythmia detection
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>
                            ...
                            5-minute sliding window PVC burden calculation
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>
                            ...
                            Review historical ECG data with gesture controls
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>
                            ...
                            Medical-grade ECG display with standard scaling
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-zinc-800/50 rounded-lg p-4 border border-zinc-700/50">
                      ...
                      <ul className="text-zinc-300 space-y-2 text-sm">
                        ...
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>
                            Compatible ECG chest strap (sold separately)
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                          <span className="text-phthalo-500 mt-1">•</span>
                          <span>
                            Stable Bluetooth connection for optimal performance
                          </span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/30 rounded-lg p-4">
                      ...
                      <p className="text-zinc-300 text-sm leading-relaxed">
                        ...
                        or clinical decision-making. All detected arrhythmias
                        and calculations should be verified by qualified
                        healthcare professionals. Do not rely on this app for
                        emergency cardiac assessment or medical interventions.
                      </p>
                    </div>
                    ...
                    <div className="text-center pt-4 border-t border-zinc-700">
                      <p className="text-zinc-500 text-sm">
                        ECG Arrhythmia Detector v1.0 | Developed by Danish
                      </p>
                    </div>
                  </div>
                </DialogContent>
