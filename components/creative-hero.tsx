        ...
        >
          ...
          <div
            ...
            style={{
              ...
              boxShadow: glowIntensity > 0 ? `0 0 ${20 + glowIntensity * 10}px rgba(138, 79, 1, ${0.5 + glowIntensity * 0.1})` : 'none'
            }}
          >
          ...
          <div 
            ...
            style={{
              borderColor: `rgba(138, 79, 1, ${0.5 + glowIntensity * 0.1})`,
          ...
          <div className="absolute bottom-0 right-0 flex items-center gap-2 bg-black/70 backdrop-blur-sm rounded-full px-3 py-1">
            <div 
              className="w-2 h-2 bg-phthalo-600 rounded-full animate-pulse"
              style={{
